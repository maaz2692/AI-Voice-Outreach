...
export default function ImportFilesPanel() {
  ...
  function handleSelectAllValid() {
    ...
    const validRowIds = selectedFile.sheets.flatMap((sheet) =>
        sheet.rows
  ...
  const validRows = selectedFile?.sheets.flatMap((sheet) =>
        ...
        <section className="rounded-2xl border border-slate-200 bg-white">
          <div className="flex flex-wrap items-center justify-between gap-4 border-b border-slate-200 px-6 py-5">
            <div>
              ...
              <p className="mt-1 text-sm text-slate-500">
                {selectedFile.totalRows} imported
                rows · {selectedRowIds.size} selected
              </p>
            </div>
